...
import com.benromdhane.omar.offroadsoft.monad.tuple.Quadruple

class EvaluateFourElements<FIRST_ELEMENT : Any, ERROR : Any> private constructor(
...
private fun <ELEMENT : Any, ERROR : Any> evaluate(
    evaluations: Set<EvaluateFourElements.Evaluation<ELEMENT, ERROR>>,
    element: ELEMENT
) =
    evaluations
