...
class EvaluateFourElementsTest {

    @Test
    fun `evaluate must return success success or multiple errors if one valid evaluation for first element and one valid evaluation for second and one valid evaluation for third and one valid evaluation for fourth was provided`() {
    ...
    @Test
    fun `evaluate must return success success or multiple errors if multiple valid evaluations for first element and multiple valid evaluations for second and multiple valid evaluations for third and multiple valid evaluations for fourth was provided`() {
        val firstElementToEvaluate = Uuid.random().toString()
        val secondElementToEvaluate = Random.nextInt()
        val thirdElementToEvaluate = Random.nextLong()
        val fourthElementToEvaluate = Random.nextDouble()
    ...
    @Test
    fun `evaluate must return failure success or multiple errors if one of multiple evaluations for first element is invalid and one of multiple evaluations for second is invalid and one of multiple evaluations for third and one of multiple evaluations for fourth is invalid was provided`() {
